...
the [pre-check/post-check hooks](https://mfernandezfunes.github.io/watchtower/lifecycle-hooks/), but will __not__ update the
containers.
...
For details see [HTTP API](https://mfernandezfunes.github.io/watchtower/http-api-mode).
...
This enables [running multiple instances](https://mfernandezfunes.github.io/watchtower/running-multiple-instances).
