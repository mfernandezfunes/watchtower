...
-   Watchtower will post a notification every time it is started. This behavior [can be changed](https://mfernandezfunes.github.io/watchtower/arguments/#without_sending_a_startup_message) with an argument.
...
services:
  watchtower:
    image: ghcr.io/mfernandezfunes/watchtower:latest
